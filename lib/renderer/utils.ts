...
export function normalizeSettings(s: RenderSettings): RenderSettings { return { ...s, maskSensitivity: clamp(s.maskSensitivity, 15, 100), textSize: clamp(s.textSize, 6, 32), spacing: clamp(s.spacing, .5, 3), density: clamp(s.density, 20, 100), contrast: clamp(s.contrast, 50, 180), brightness: clamp(s.brightness, 50, 150), rotation: clamp(s.rotation, -45, 45) }; }
